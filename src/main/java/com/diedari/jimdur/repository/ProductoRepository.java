...
public interface ProductoRepository extends JpaRepository<Producto, Long> {
    ...
    // Usé @Query porque Spring Data JPA no tiene una convención directa para
    // obtener los N últimos productos ordenados por ID descendente.
    ...
    // Método para obtener productos para la vista de productos en la pagina de los
    // usuarios
